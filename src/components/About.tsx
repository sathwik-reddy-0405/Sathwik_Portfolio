                ...
                >
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-16">
                            <span className="text-black/40 font-mono tracking-[0.2em] sm:tracking-[0.4em] text-[10px] sm:text-xs mb-4 uppercase inline-block">Core Specifications</span>
                            <br />
                            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-black inline-block relative font-serif tracking-tight pr-1 sm:pr-2">
                                Technical<span className="opacity-40">.</span>Foundation
                            </h2>
                            <p className="text-black/60 text-base sm:text-lg md:text-xl leading-relaxed sm:leading-loose max-w-4xl mx-auto font-light italic mt-4 sm:mt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {stats.map((stat, index) => (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    whileHover={{ y: -8 }}
                                    className="relative p-6 sm:p-8 md:p-10 rounded-none bg-gray-50 border border-black/10 hover:border-black transition-colors duration-500 group shadow-sm hover:shadow-[6px_6px_0px_rgba(0,0,0,1)] md:hover:shadow-[10px_10px_0px_rgba(0,0,0,1)] hover:bg-white overflow-hidden"
                                >
                                    ...
                                    <div className="text-4xl sm:text-5xl md:text-6xl font-black text-black mb-4 sm:mb-6 tracking-tighter transform group-hover:scale-105 group-hover:translate-x-2 transition-transform duration-500 origin-left">
                                        {stat.value}
                                    </div>
                                    <div className="text-[10px] sm:text-xs text-black/40 uppercase tracking-[0.2em] font-mono font-bold group-hover:text-black transition-colors duration-500 flex items-center gap-2 sm:gap-3">
